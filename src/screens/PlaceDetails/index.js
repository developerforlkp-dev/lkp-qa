...
function LocationSection({ place }) {
  ...
  return (
    <section className="location-section" style={{ background: theme === 'dark' ? BG : W, padding: isMobile ? "32px 24px" : "48px 80px" }}>
      <div style={{ maxWidth: 1320, margin: "0 auto", boxSizing: "border-box", width: "100%" }}>
        ...
        <div style={{
          ...
          <Rev delay={0.1} style={{ height: isMobile ? "250px" : "100%", minWidth: 0 }}>
            <div style={{ position: "relative", height: "100%", minHeight: isMobile ? "250px" : 320, width: "100%", overflow: "hidden", borderRadius: 16, border: `1px solid ${B}`, boxSizing: "border-box" }}>
              <div style={{
                position: "absolute",
                top: 16,
                right: 16,
          ...
          <Rev delay={0.2} style={{ height: "100%" }}>
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", height: "100%", padding: isMobile ? 0 : "16px 16px 16px 0" }}>
              <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", margin: 0, padding: 0 }}>
                {address && (
                  <li style={{ display: "flex", gap: isMobile ? 16 : 24, alignItems: isMobile ? "flex-start" : "center", borderBottom: `1px solid ${B}`, padding: "12px 0", borderTop: isMobile ? "none" : `1px solid ${B}` }}>
                    ...
                    <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: isMobile ? 4 : 16, alignItems: isMobile ? "flex-start" : "center", flex: 1, minWidth: 0 }}>
                      ...
                      <span style={{ fontSize: 16, color: FG, fontWeight: 400, lineHeight: 1.4, fontFamily: '"Inter", sans-serif', flex: isMobile ? "none" : 1, minWidth: 0, overflowWrap: "anywhere", wordBreak: "normal", whiteSpace: "normal" }}>{address}</span>
                    </div>
                  </li>
                )}

                {landmark && (
                  <li style={{ display: "flex", gap: isMobile ? 16 : 24, alignItems: isMobile ? "flex-start" : "center", borderBottom: `1px solid ${B}`, padding: "12px 0"  }}>
                    <div style={{ width: 40, height: 40, borderRadius: "8px", background: theme === 'dark' ? '#1E293B' : '#F0F9FA', display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                    ...
                    <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: isMobile ? 4 : 16, alignItems: isMobile ? "flex-start" : "center", flex: 1, minWidth: 0 }}>
                      ...
                      <span style={{ fontSize: 16, color: FG, fontWeight: 400, lineHeight: 1.4, fontFamily: '"Inter", sans-serif', flex: isMobile ? "none" : 1, minWidth: 0, overflowWrap: "anywhere", wordBreak: "normal", whiteSpace: "normal" }}>{landmark}</span>
                    </div>
                  </li>
                )}
                ...
                {city && (
                  <li style={{ display: "flex", gap: isMobile ? 16 : 24, alignItems: isMobile ? "flex-start" : "center", borderBottom: `1px solid ${B}`, padding: "12px 0"  }}>
                    ...
                    <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: isMobile ? 4 : 16, alignItems: isMobile ? "flex-start" : "center", flex: 1, minWidth: 0 }}>
                      <span style={{ fontSize: "12px", letterSpacing: "0.15em", textTransform: "uppercase", color: A, width: isMobile ? "auto" : 110, flexShrink: 0, fontWeight: 700, fontFamily: '"Inter", sans-serif' }}>City/Town</span>
                      <span style={{ fontSize: 16, color: FG, fontWeight: 400, lineHeight: 1.4, fontFamily: '"Inter", sans-serif', flex: isMobile ? "none" : 1, minWidth: 0, overflowWrap: "anywhere", wordBreak: "normal", whiteSpace: "normal" }}>{city}</span>
                    </div>
                  </li>
                )}
                ...
                {district && (
                  <li style={{ display: "flex", gap: isMobile ? 16 : 24, alignItems: isMobile ? "flex-start" : "center", borderBottom: `1px solid ${B}`, padding: "12px 0"  }}>
                    ...
                    <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: isMobile ? 4 : 16, alignItems: isMobile ? "flex-start" : "center", flex: 1, minWidth: 0 }}>
                      ...
                      <span style={{ fontSize: 16, color: FG, fontWeight: 400, lineHeight: 1.4, fontFamily: '"Inter", sans-serif', flex: isMobile ? "none" : 1, minWidth: 0, overflowWrap: "anywhere", wordBreak: "normal", whiteSpace: "normal" }}>{district}</span>
                    </div>
                  </li>
                )}
                ...
                {state && (
                  <li style={{ display: "flex", gap: isMobile ? 16 : 24, alignItems: isMobile ? "flex-start" : "center", borderBottom: `1px solid ${B}`, padding: "12px 0"  }}>
                    ...
                    <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: isMobile ? 4 : 16, alignItems: isMobile ? "flex-start" : "center", flex: 1, minWidth: 0 }}>
                      <span style={{ fontSize: "12px", letterSpacing: "0.15em", textTransform: "uppercase", color: A, width: isMobile ? "auto" : 110, flexShrink: 0, fontWeight: 700, fontFamily: '"Inter", sans-serif' }}>State/Region</span>
                      <span style={{ fontSize: 16, color: FG, fontWeight: 400, lineHeight: 1.4, fontFamily: '"Inter", sans-serif', flex: isMobile ? "none" : 1, minWidth: 0, overflowWrap: "anywhere", wordBreak: "normal", whiteSpace: "normal" }}>{state}</span>
                    </div>
                  </li>
                )}
                ...
                {country && (
                  <li style={{ display: "flex", gap: isMobile ? 16 : 24, alignItems: isMobile ? "flex-start" : "center", borderBottom: `1px solid ${B}`, padding: "12px 0"  }}>
                    ...
                    <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: isMobile ? 4 : 16, alignItems: isMobile ? "flex-start" : "center", flex: 1, minWidth: 0 }}>
                      ...
                      <span style={{ fontSize: 16, color: FG, fontWeight: 400, lineHeight: 1.4, fontFamily: '"Inter", sans-serif', flex: isMobile ? "none" : 1, minWidth: 0, overflowWrap: "anywhere", wordBreak: "normal", whiteSpace: "normal" }}>{country}</span>
                    </div>
                  </li>
                )}
                ...
                {instructions && (
                  <li style={{ display: "flex", gap: isMobile ? 16 : 24, alignItems: isMobile ? "flex-start" : "center", borderBottom: `1px solid ${B}`, padding: "12px 0"  }}>
                    ...
                    <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: isMobile ? 4 : 16, alignItems: isMobile ? "flex-start" : "center", flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ flex: isMobile ? "none" : 1, minWidth: 0, overflowWrap: "anywhere", wordBreak: "normal", whiteSpace: "normal" }}><ExpandableInstructionText text={instructions} FG={FG} A={A} /></div>
                    </div>
                  </li>
                )}
                ...
                {(!address && !city && !state && !landmark && !district && !country && !instructions) && (
                  <li style={{ display: "flex", gap: isMobile ? 16 : 24, alignItems: isMobile ? "flex-start" : "center", borderBottom: `1px solid ${B}`, padding: "12px 0"  }}>
                    ...
                    <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: isMobile ? 4 : 16, alignItems: isMobile ? "flex-start" : "center", flex: 1, minWidth: 0 }}>
                      ...
                      <span style={{ fontSize: 16, color: M, fontWeight: 400, lineHeight: 1.4, fontFamily: '"Inter", sans-serif', flex: isMobile ? "none" : 1, minWidth: 0, overflowWrap: "anywhere", wordBreak: "normal", whiteSpace: "normal" }}>Specific regional details are available on the map.</span>
                    </div>
                  </li>
                )}
              </ul>
