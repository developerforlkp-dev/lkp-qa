        ...
        <div style={{ display: "flex", flexDirection: "column", gap: isMobile ? "10px" : "12px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "14px", marginTop: "4px" }}>
            ...
            <div style={{ display: "flex", flexWrap: isMobile ? "nowrap" : "wrap", gap: "8px", overflowX: isMobile ? "auto" : "visible", paddingBottom: isMobile ? "4px" : "0", scrollbarWidth: "none", msOverflowStyle: "none" }}>
              {room.bedType && <span style={{ flexShrink: 0, fontSize: "11px", fontWeight: 600, color: FG, background: W, padding: "6px 12px", borderRadius: "100px", border: `1px solid ${B}`, whiteSpace: "nowrap" }}>{room.bedType}</span>}
              {room.roomSize && <span style={{ flexShrink: 0, fontSize: "11px", fontWeight: 600, color: FG, background: W, padding: "6px 12px", borderRadius: "100px", border: `1px solid ${B}`, whiteSpace: "nowrap" }}>{room.roomSize} sq ft</span>}
              {features.map((f, i) => (
                <span key={i} style={{ flexShrink: 0, fontSize: "11px", fontWeight: 600, color: FG, background: W, padding: "6px 12px", borderRadius: "100px", border: `1px solid ${B}`, whiteSpace: "nowrap" }}>
                  {f}
                </span>
              ))}
            </div>
