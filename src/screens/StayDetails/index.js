                ...
                {stay?.lkpQualityIndex ? (
                  <>
                    ...
                    {(() => {
                      ...
                      const ratingText = stay.lkpQualityIndex.displayName || stay.lkpQualityIndex.ratingText || stay.lkpQualityIndex.status || stay.lkpQualityIndex.ratingLabel || "Exceptional";
      ...
      <div style={{ width: isMobile ? "100%" : "calc(100% - 80px)", maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <div style={{
          ...
          <Rev delay={0.1} style={{ height: "100%" }}>
            <div style={{ height: isMobile ? "240px" : "400px", minHeight: isMobile ? "240px" : 320, maxHeight: isMobile ? "none" : "calc(100vh - 160px)", position: isMobile ? "relative" : "sticky", top: isMobile ? "auto" : 120, overflow: "hidden", borderRadius: 16, border: `1px solid ${B}` }}>
              <div style={{
                position: "absolute",
                top: 16,
                right: 16,
